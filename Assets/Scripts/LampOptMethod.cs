...
public class LampOptMethod : MonoBehaviour
{
    public OptMethod simulationOptMethod;
    ...
    void Start()
    {        
        Debug.Assert(simulationOptMethod);
        Debug.Assert(head);        
    ...
    void Update()
    {
        ...
        if (!Input.GetKey(KeyCode.LeftAlt) && Input.GetMouseButtonDown(0)) {
            ...
            if (Physics.Raycast(ray, out hit)) {
                ...
                if (hitObj.name == "base" && hitObj.GetComponentInParent<LampOptMethod>() != null) {
